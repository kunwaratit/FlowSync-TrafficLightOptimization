...
const Admin = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          "http://127.0.0.1:8000/api/hour-status/",{
            headers: {
  ...
  const aggregateDataByTime = (data) => {
    ...
    return {
      aggregatedData: aggregatedArray,
      totalVehicles,
      totalCars,
      totalBikes,
      totalBuses,
        ...
        <div className="holdcontainer flex">
          ...
          <div className="vehicle-info">
            <div className="holdcontainer veh">
              <div className="vehhlogo">
                <FaBusAlt fill="white" size={56} />
              </div>
              ...
              <div className="everyside">
                <p>
                  East:<span>{east.buses}</span>{" "}
                </p>
                <p>
                  West :<span>{west.buses}</span>{" "}
                </p>
                <p>
                  North :<span>{north.buses}</span>{" "}
                </p>
                <p>
                  South :<span>{south.buses}</span>{" "}
                </p>
              </div>
            </div>
            <div className="holdcontainer veh">
              <div className="vehhlogo">
                <FaCar fill="white" size={56} />
              </div>
              <div className="total-bus">
                <p>Total Car </p>
                <h1>{totalCars}</h1>
              ...
              <div className="everyside">
                <p>
                  East:<span>{east.cars}</span>{" "}
                </p>
                <p>
                  West :<span>{west.cars}</span>{" "}
                </p>
                <p>
                  North :<span>{north.cars}</span>{" "}
                </p>
                <p>
                  South :<span>{south.cars}</span>{" "}
                </p>
              </div>
            </div>
            <div className="holdcontainer veh">
              <div className="vehhlogo">
                <RiMotorbikeFill fill="white" size={56} />
              </div>
              <div className="total-bus">
                <p>Total Bikes </p>
                <h1>{totalBikes}</h1>
              ...
              <div className="everyside">
                <p>
                  East:<span>{east.bikes}</span>{" "}
                </p>
                <p>
                  West :<span>{west.bikes}</span>{" "}
                </p>
                <p>
                  North :<span>{north.bikes}</span>{" "}
                </p>
                <p>
                  South :<span>{south.bikes}</span>{" "}
                </p>
              </div>
            </div>
          </div>
